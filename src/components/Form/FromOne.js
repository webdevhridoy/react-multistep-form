...
import { FromContext } from '../../Fromcontext/FromProvider';
...
const FromOne = () => {
    const { firstName,
        ...
        setEmail,
        country,
        setCountry } = useContext(FromContext);
            ...
            <div className='w-full md:w-4/5'>
                <div className='flex justify-center flex-col items-center mx-auto max-w-[39.5rem]'>
                    <div>
                        ...
                        <h2 className='font-serif text-lg md:text-2xl text-center text-gray-700 px-6 md:px-20'>Becoming a <span className='text-[#56c870] italic'>part of our global community</span> has never been easier
                        </h2>
                    </div>
                        ...
                        <form onSubmit={handleSubmit(handleSignIn)}>
                            <div className="form-control w-full text-left mt-2 ">
                                ...
                                <div className='relative flex items-center border-2 rounded p-1'>
                                    ...
                                    <input
                                        {...register("firstName", { required: "Field Address is required" })}
                                        id='first-name'
                                        type="text"
                                        name="firstName"
                                        value={firstName}
